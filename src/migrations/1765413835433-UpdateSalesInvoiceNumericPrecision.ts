...
export class UpdateSalesInvoiceNumericPrecision1765413835433 implements MigrationInterface {
    name = 'UpdateSalesInvoiceNumericPrecision1765413835433'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sales_invoices" ALTER COLUMN "partial_payment_amount" TYPE numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "sales_invoices" ALTER COLUMN "remaining_amount" TYPE numeric(15,2)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sales_invoices" ALTER COLUMN "remaining_amount" TYPE numeric(10,2)`);
        await queryRunner.query(`ALTER TABLE "sales_invoices" ALTER COLUMN "partial_payment_amount" TYPE numeric(10,2)`);
